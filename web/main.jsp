...
<div id="header">
    ...
    <div class="dropdown" onclick="toggleDropdown()">
        <div>
            <img src="static/images/QQ.jpg" alt="UserAvatar" class="userImg" id="userImg">
            <div class="userName" id="userName"><%=session.getAttribute("username")%></div>
        </div>
        <div class="dropdown-content" id="dropdown-content">
            <a href="#">查看个人信息</a>
            <a href="/login?operation=logout">退出登录</a>
        </div>
    </div>
</div>
<div id="container">
