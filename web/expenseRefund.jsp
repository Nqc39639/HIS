...
<%@ page import="entity.DisposalRequest" %>
...
<div class="table-container">
    <table>
        ...
        <tr>
            ...
            <td>
                <a href="/expenseReturnServlet?operation=calc&Sum=<%=disposalRequest.getTechPrice()%>&registerId=<%=disposalRequest.getRegisterId()%>&medicalTechnologyId=<%=disposalRequest.getMedicalTechnologyId()%>">退费</a>
                <a href="/expenseReturnServlet?operation=delete&registerId=<%=disposalRequest.getRegisterId()%>&medicalTechnologyId=<%=disposalRequest.getMedicalTechnologyId()%>">删除</a>
            </td>
        </tr>
        <%}%>
    </table>
