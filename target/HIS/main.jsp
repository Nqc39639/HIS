...
<div id="container">
    <div id="sidebar">
        ...
        <ul id="examination" class="nav-item">
            <li><a href="检查申请.jsp" target="iframe_content">检查申请</a></li>
            <li><a href="患者录入.jsp" target="iframe_content">患者录入</a></li>
            <li><a href="检查录入.jsp" target="iframe_content">检查录入</a></li>
            <li><a href="检查管理.jsp" target="iframe_content">检查管理</a></li>
        </ul>
        ...
        <ul id="lab" class="nav-item">
            <li><a href="检验申请.jsp" target="iframe_content">检验申请</a></li>
            <li><a href="患者录入.jsp" target="iframe_content">患者录入</a></li>
            <li><a href="检验录入.jsp" target="iframe_content">检验录入</a></li>
            <li><a href="检验管理.jsp" target="iframe_content">检验管理</a></li>
        </ul>
        ...
        <ul id="pharmacy" class="nav-item">
            ...
            <li><a href="drugStorage.jsp" target="iframe_content">药库管理</a></li>
            <li><a href="#" target="iframe_content">发退药记录管理</a></li>
        </ul>
        ...
        <ul id="procedure" class="nav-item">
            <li><a href="处置申请.jsp" target="iframe_content">处置申请</a></li>
            <li><a href="患者录入.jsp" target="iframe_content">患者录入</a></li>
            <li><a href="处置录入.jsp" target="iframe_content">处置录入</a></li>
            <li><a href="处置管理.jsp" target="iframe_content">处置管理</a></li>
        </ul>
    </div>
    <div id="content">
        <div id="pane">
